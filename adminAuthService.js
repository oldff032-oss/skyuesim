...
const ALL_PERMISSIONS=['users.read','users.manage','support.reply','refunds.manage','esim.retry','esim.manage','activation_code.read','broadcasts.manage','users.delete','backups.manage','security.manage','operations.manage','settings.manage'];
const ROLE_PERMISSIONS={
  super_admin:ALL_PERMISSIONS,
  admin:['users.read','users.manage','support.reply','esim.retry','activation_code.read','operations.manage'],
