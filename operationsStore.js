...
let store = { announcements: [], notes: {}, blacklist: { emails: [], iccids: [] }, templates: [] };
async function bootstrap(){ store = { announcements: [], notes: {}, blacklist: { emails: [], iccids: [] }, templates: [], ...(await storage.load('operations.json', store)) }; }
