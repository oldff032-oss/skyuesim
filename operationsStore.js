...
const defaults = () => ({
  ...
  versionInfo: { frontend:'2.6.0', backend:'2.6.0', serviceWorker:'v86', cache:'signal-shell-v86-home-passport', deployedAt:null, changelog:['Нова інформативна головна картка Signal eSIM','Назва активного пакета береться з фактичної покупки','10, 20 та безлімітний обсяг правильно зіставляються з тарифом','Points і швидкі дії без зайвого вибору тарифів на головній','Компактна 3D-навігація для мобільного екрана'],criticalRefreshToken:null,criticalAssets:['/dashboard.html','/plans.html','/signal-card-scenes-v1.png','/profile.html','/notifications.html','/activity.html','/savings.html','/family-center.html','/family-trip.html','/signal-universe.html','/i18n.js','/style.css','/experience.css','/experience.js','/wallet-pass.html','/pwa.js','/sw.js'] },
  clientVersions: {},
