...
const defaults = () => ({
  ...
  versionInfo: { frontend:'1.6.2', backend:'1.0.0', serviceWorker:'v60', cache:'signal-shell-v60-support-mobile', deployedAt:null, changelog:[],criticalRefreshToken:null,criticalAssets:['/i18n.js','/style.css','/pwa.js','/sw.js'] },
  clientVersions: {},
