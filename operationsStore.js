...
const defaults = () => ({
  ...
  versionInfo: { frontend:'2.5.0', backend:'2.5.0', serviceWorker:'v85', cache:'signal-shell-v85-premium-cards', deployedAt:null, changelog:['Новий преміальний головний екран Signal','Живі картки країн та активної eSIM','Рівні Basic, Standard і Unlimited з прямим вибором','Signal Points і доступні винагороди на головній','Компактні розумні дії та Signal Space'],criticalRefreshToken:null,criticalAssets:['/dashboard.html','/plans.html','/signal-card-scenes-v1.png','/profile.html','/notifications.html','/activity.html','/savings.html','/family-center.html','/family-trip.html','/signal-universe.html','/i18n.js','/style.css','/experience.css','/experience.js','/wallet-pass.html','/pwa.js','/sw.js'] },
  clientVersions: {},
