...
if ('serviceWorker' in navigator) {
  ...
  navigator.serviceWorker.addEventListener('controllerchange',()=>{
    if(sessionStorage.getItem('signal_sw_reloaded_v70')==='1')return;
    sessionStorage.setItem('signal_sw_reloaded_v70','1');
    location.reload();
  });
}
...
const SIGNAL_FRONTEND_VERSION='2.0.0',SIGNAL_SW_VERSION='v70',SIGNAL_CACHE_VERSION='signal-shell-v70-global-travel';
