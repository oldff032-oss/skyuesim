...
if ('serviceWorker' in navigator) {
  navigator.serviceWorker.register('/sw.js?v=61', { updateViaCache: 'none' }).then(registration => registration.update()).catch(() => {});
  navigator.serviceWorker.addEventListener('controllerchange',()=>{
    if(sessionStorage.getItem('signal_sw_reloaded_v61')==='1')return;
    sessionStorage.setItem('signal_sw_reloaded_v61','1');
    location.reload();
  });
}
...
const SIGNAL_FRONTEND_VERSION='1.6.3',SIGNAL_SW_VERSION='v61',SIGNAL_CACHE_VERSION='signal-shell-v61-ticket-flow';
