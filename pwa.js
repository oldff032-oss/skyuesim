...
if ('serviceWorker' in navigator) {
  navigator.serviceWorker.register('/sw.js?v=73', { updateViaCache: 'none' }).then(registration => registration.update()).catch(() => {});
  navigator.serviceWorker.addEventListener('controllerchange',()=>{
    if(sessionStorage.getItem('signal_sw_reloaded_v73')==='1')return;
    sessionStorage.setItem('signal_sw_reloaded_v73','1');
    location.reload();
  });
}
...
const SIGNAL_FRONTEND_VERSION='2.0.3',SIGNAL_SW_VERSION='v73',SIGNAL_CACHE_VERSION='signal-shell-v73-pin-email-recovery';
