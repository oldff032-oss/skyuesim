...
if ('serviceWorker' in navigator) {
  navigator.serviceWorker.register('/sw.js?v=60', { updateViaCache: 'none' }).then(registration => registration.update()).catch(() => {});
  navigator.serviceWorker.addEventListener('controllerchange',()=>{
    if(sessionStorage.getItem('signal_sw_reloaded_v60')==='1')return;
    sessionStorage.setItem('signal_sw_reloaded_v60','1');
    location.reload();
  });
}
...
const SIGNAL_FRONTEND_VERSION='1.6.2',SIGNAL_SW_VERSION='v60',SIGNAL_CACHE_VERSION='signal-shell-v60-support-mobile';
